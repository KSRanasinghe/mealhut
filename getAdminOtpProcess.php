...
if (empty($fname)) {
    ...
    if ($user_num == 0) {
        ...
        Database::push("INSERT INTO `user` (`fname`,`lname`,`email`,`otp`,`status_id`) VALUES('" . $fname . "','" . $lname . "','" . $email . "','" . $otp . "','1')");
        ...
        $mail->isHTML(true);
        $mail->Subject = 'One Time Password - MealHut Admin Account';
                                              ...
                                              <p style="font-size: 14px; line-height: 120%">
                                                <span
                                                  style="
                                                    ...
                                                    color: #666666;
                                                  "
                                                  >Your MealHut one time password is,</span
                                                >
                                              </p>
                                              <p style="font-size: 14px; line-height: 120%">
                                                 
                                              ...
                                              <p style="line-height: 130%; font-size: 14px">
                                                <span
                                                  ...
                                                  ><span
                                                    ...
                                                    "
                                                    ><em
                                                      >If you do not want to register to admin panel or did not request this,
