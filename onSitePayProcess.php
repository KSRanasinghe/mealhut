...
if (isset($_SESSION["m"])) {
    ...
    if (isset($_POST["a"])) {
        ...
        Database::push("INSERT INTO `invoice_payment` (`payment`,`payment_type_id`,`invoice_id`) VALUES(
            '" . $amount . "','2','" . $invoice_id . "')");
        #send email
                                  ...
                                  <td
                                    ...
                                    <div style="color: #676b6b; line-height: 140%; text-align: left; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 140%; text-align: center;"><strong><span
                                            style="font-size: 16px; line-height: 22.4px;">Amount Due</span></strong></p>
                                    </div>
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    ...
                                    <div style="color: #676b6b; line-height: 140%; text-align: left; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 140%; text-align: center;"><strong><span
                                            style="font-size: 16px; line-height: 22.4px;">Date Confirmed</span></strong></p>
                                    </div>
                                    ...
                                    <div style="color: #222222; line-height: 140%; text-align: left; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 140%; text-align: center;"><span
                                          style="font-size: 14px; line-height: 19.6px;"><span
                                            style="line-height: 19.6px; font-size: 14px;">M-COD</span></span>
                                      </p>
                                    </div>
